...
public class GenMonitorDecoratorVisitorImpl extends AbstractVisitorImpl {
	...
	public void visit(MOperation mOperation) {
		...
		if (!mOperation.getType().getName().equals("void")) {
			appendSystemOutLine("\"return: \" + " + firstLetterToLowerCase(mOperation.getName()));
	...
	private void visitPrintParameter(MParameter mParameter) {
		appendSystemOutLine("\"parameter " + mParameter.getName() + ": \" + " + mParameter.getName());
	}
